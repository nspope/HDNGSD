...
hfs1d <- function(shf, weights) {
    .Call(`_haplodiplo_hfs1d`, shf, weights)
}

basis <- function(hfs3d, config0, config1, config2) {
    .Call(`_haplodiplo_basis`, hfs3d, config0, config1, config2)
}
